...
import net.Rats.LandOfShinobi.item.armor.client.model.MistPantsModel;
...
public class MistPantsItem extends AbstractArmorItem {
    private static final String TEXTURE_LOCATION = makeCustomTextureLocation(landofshinobiMod.MODID, "mist_pants");

    public MistPantsItem() {
    ...
    protected ArmorModelProvider createModelProvider() {
        return new SimpleModelProvider(MistPantsModel::createBodyLayer, MistPantsModel::new);
    }
